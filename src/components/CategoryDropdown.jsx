...
export default function CategoryDropdown({ onToggle }) {
  return (
    <>
      ...
      <span className="px-5 py-1 rounded-lg text-2xl font-medium text-gray-850 cursor-pointer hover:bg-emerald-50 hover:text-emerald-700 transition">
        Categories
      </span>
      ...
      <div className="lg:hidden w-full">
        <span
          onClick={onToggle}
          className="px-5 py-1 rounded-lg text-2xl font-medium text-gray-850 cursor-pointer w-full"
        >
          Categories
        </span>
      </div>
